...
namespace CloudSource.Playnite.Providers.GoogleDrive
{
    internal sealed class GoogleDriveProviderConfiguration
    {
        ...
        public GoogleDriveAccountConfiguration CreateAccountConfiguration(string clientId)
        {
            return new GoogleDriveAccountConfiguration(clientId, AccountId, AccountDisplayName);
        }
